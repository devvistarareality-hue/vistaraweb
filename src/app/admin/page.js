...
const MODULES = [
  ...
  { name: 'Pre-Sales',          desc: 'Lead tracking and follow-up pipeline',         icon: 'clock',     accent: { bg: '#E0F7FA', icon: '#0097A7', gradient: 'rgba(0,151,167,0.07)'  }, href: '/placeholder?title=Pre-Sales',    soon: true  },
