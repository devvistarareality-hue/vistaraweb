...
const MODULES = [
  ...
  { name: 'Execution',          desc: 'Tasks, milestones and project delivery',       icon: 'checklist', accent: { bg: 'var(--green)', icon: 'var(--success)', gradient: 'var(--band-green)'  }, href: '/m/execution',                    soon: false },
