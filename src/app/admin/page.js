...
const MODULES = [
  ...
  { name: 'Accounts Receivable', desc: 'Collections, dues, ageing and interest',      icon: 'coins',     accent: { bg: 'var(--blue)', icon: 'var(--accent)', gradient: 'var(--band-blue)' }, href: '/m/ar',                          soon: false },
