          ...
          {isVRLAdmin && (
            <div style={{ marginBottom: 24 }}>
              ...
              <select
                ...
                style={{ ...s.input, maxWidth: 420, color: selectedCompanyId ? 'var(--text)' : 'var(--muted)' }}
              >
          ...
          <div style={{ marginBottom: 24 }}>
            <label style={s.label}>
              ...
              {needsReportingManager(form.role)
                ? <span style={{ fontWeight: 400, color: 'var(--warning)' }}>(required at this role)</span>
...
const s = {
  ...
  backBtn:    { background: 'none', border: 'none', fontSize: 14, color: 'var(--muted)', cursor: 'pointer', fontWeight: 600 },
  pageTitle:  { fontSize: 24, fontWeight: 800, color: 'var(--text)' },
  card: {
  ...
  label:      { display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--muted)', marginBottom: 6 },
  hintInline: { fontSize: 11, fontWeight: 500, color: 'var(--faint)' },
  input:      { width: '100%', height: 44, padding: '0 12px', borderRadius: 8, border: '1.5px solid var(--border)', fontSize: 14, boxSizing: 'border-box' },
  ...
  prefixValue: { fontWeight: 700, color: 'var(--text)', letterSpacing: 2 },
  prefixAuto:  { fontSize: 11, fontWeight: 600, color: 'var(--muted)', backgroundColor: 'var(--border)', borderRadius: 4, padding: '2px 7px' },
  checkGrid:  { display: 'flex', flexWrap: 'wrap', gap: '10px 20px' },
  checkLabel: { display: 'flex', alignItems: 'center', gap: 7, fontSize: 13, color: 'var(--text)', cursor: 'pointer' },
  formFooter: { display: 'flex', justifyContent: 'flex-end', gap: 12 },
  cancelBtn:  { padding: '10px 20px', backgroundColor: 'var(--surface-2)', color: 'var(--muted)', border: 'none', borderRadius: 14, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  saveBtn:    { padding: '10px 28px', backgroundColor: 'var(--strong)', color: '#fff', border: 'none', borderRadius: 14, fontSize: 14, fontWeight: 700, cursor: 'pointer' },
};
