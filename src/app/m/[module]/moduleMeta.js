// Slug → module metadata for the generic module shell.
export const MODULE_META = {
  hr:        { name: 'HR',                 accent: '#3D5AFE', desc: 'People, org structure and teams' },
  accounts:  { name: 'Accounts & Finance', accent: '#0D9488', desc: 'Accounting, payments and financials' },
