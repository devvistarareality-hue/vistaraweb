      ...
      <div style={{ marginTop: 24, display: 'flex', flexWrap: 'wrap', gap: 16 }}>
        ...
        <Link href={`/m/${slug}/approvals`} style={{ textDecoration: 'none' }}>
          <div style={{ width: 280, background: '#fff', borderRadius: 16, padding: 20, boxShadow: '0 4px 16px rgba(184,196,214,0.22)', border: '1px solid #EDF1F7', cursor: 'pointer' }}>
            ...
            <div style={{ fontSize: 15, fontWeight: 700, color: '#1A1A2E', marginBottom: 5 }}>Approvals</div>
            <div style={{ fontSize: 12, color: '#8492A6', marginBottom: 10 }}>Review pending LOI &amp; EOI bookings and approve/reject each one's Accounts-stage sign-off</div>
            <div style={{ fontSize: 12, fontWeight: 700, color: meta.accent }}>Open →</div>
          </div>
        </Link>
        )}
        ...
        <Link href={`/m/${slug}/bookings`} style={{ textDecoration: 'none' }}>
          <div style={{ width: 280, background: '#fff', borderRadius: 16, padding: 20, boxShadow: '0 4px 16px rgba(184,196,214,0.22)', border: '1px solid #EDF1F7', cursor: 'pointer' }}>
            ...
            <div style={{ fontSize: 12, color: '#8492A6', marginBottom: 10 }}>Approved bookings and cancellations, project-wise</div>
            <div style={{ fontSize: 12, fontWeight: 700, color: meta.accent }}>Open →</div>
          </div>
        </Link>
        )}
