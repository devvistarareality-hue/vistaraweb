...
const s = {
  ...
  title: { fontSize: 26, fontWeight: 800, color: 'var(--text)', marginBottom: 10 },
  sub:   { fontSize: 15, color: 'var(--muted)', marginBottom: 8, maxWidth: 320 },
  note:  { fontSize: 13, color: 'var(--faint)' },
};
