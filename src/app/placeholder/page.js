...
const s = {
  ...
  gear: {
    ...
    height:          40,
    borderRadius:    '50%',
    border:          '4px solid #9A9EA5',
    backgroundColor: '#DFE2E6',
  },
  title: { fontSize: 26, fontWeight: 800, color: '#1D1D1F', marginBottom: 10 },
  sub:   { fontSize: 15, color: '#6E7278', marginBottom: 8, maxWidth: 320 },
  note:  { fontSize: 13, color: '#9A9EA5' },
};
