...
const ICON = {
  ...
  ar_followup_assigned: 'phone', ar_followup_due: 'phone', ar_followup_overdue: 'clock', ar_collections_digest: 'chart',
...
const TYPE_COLOR = {
  ...
  ar_followup_assigned: 'var(--accent)', ar_followup_due: 'var(--warning)', ar_followup_overdue: 'var(--danger)', ar_collections_digest: 'var(--accent)',
