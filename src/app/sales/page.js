...
function AdminDashboard({ user, adminView = false }) {
  ...
  const cards = stats ? [
    ...
    { label: 'SV Interested',     value: stats.sv_interested_count,     icon: <IconTrend />, color: '#DCFCE7', textColor: '#15803D', href: `${convHref}?tab=sv` },
    { label: 'SV Not Interested', value: stats.sv_not_interested_count, icon: <IconActivity />, color: '#FEE2E2', textColor: '#DC2626', href: `${convHref}?tab=sv` },
...
function STMDashboard({ user }) {
  ...
  const svInterested    = stats?.sv_interested_count ?? 0;
      ...
      {loading ? <SkeletonGrid count={10} grid={stmStatsGrid} /> : (
        <div style={stmStatsGrid}>
          {[
            ...
            { label: 'SV Interested',     value: svInterested,    icon: <IconEye />,      color: '#DCFCE7', textColor: '#15803D', href: '/sales/site-visits?tab=completed' },
            { label: 'SV Not Interested', value: svNotInterested, icon: <IconActivity />, color: '#FEE2E2', textColor: '#DC2626', href: '/sales/site-visits?tab=completed' },
            { label: 'Closures',       value: closed,  icon: <IconCheck />,    color: '#E0F2F1', textColor: '#0F766E', href: '/sales/my-conversions?tab=closures' },
